...
contract TokenExchange {
    ...
    address tokenAddr =  0x2d2aa05140da0e4A90EC68143095aC34f66B729a;                 
    FinnCoin private token = FinnCoin(tokenAddr);                                              
    ...
    // Function createPool: Initializes a liquidity pool between Token and ETH.
    ...
    // Function priceToken: Calculate the price of token in ETH.
    function priceToken() 
        public 
        view
        returns (uint)
    ...
    // Function priceETH: Calculate the price of ETH for token.
    function priceETH()
        public
        // view
        returns (uint)
    ...
    // Function swapTokensForETH: Swaps token with ETH
