...
contract FinnCoin is IERC20 {
    using SafeMath for uint;

    string public constant symbol = 'FINN';             
    string public constant name = 'FinnCoin';          
    ...
    // Function _mint: Create more of my tokens.
        ...
        MintingEnabled
    {
        ...
        emit Mint('Just minted this many FinnCoin: ', amount);
        
    }

    // Function _disable_mint: Disable future minting of my token.
    ...
    function transfer(address receiver, uint numTokens) 
        ...
        returns (bool) 
    {
        require(numTokens <= balances[msg.sender], "transfer failed");
